...
android {
    namespace = "com.tvboxplayer"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.tvboxplayer"
        ...
        resValue("string", "app_name", "TV Box Player")
    }
...
dependencies {
    ...
    // Security - Encrypted SharedPreferences & Crypto
    implementation("androidx.security:security-crypto:1.1.0-alpha06")

    // Google Drive API (for content sync)
